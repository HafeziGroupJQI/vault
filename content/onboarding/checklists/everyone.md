...
these in roughly this order during your first week or two.
...
- **UMD ID card** — you need your physical ID before anything else can be
  activated on it.
...
- Contact **Brittany Antrum** in the Chair's Office —
  [bantrum@umd.edu](mailto:bantrum@umd.edu) — about parking.
- General reference: [UMD Transportation Services (DOTS)](https://transportation.umd.edu/parking).
  Graduate assistants can also get after-hours Campus License Plate
  Registration for restricted lots (4 pm–7 am weekdays, all weekend).

## Purchasing / ordering stuff
...
These don't need prose — just links:

- [UMD Graduate School resources](https://gradschool.umd.edu/)
- [Off-campus housing service](https://offcampushousing.umd.edu/)
- Engineering Graduate Student Society (EGSS) board-game night — Wednesdays
  6 pm, free food, open to grad students.
